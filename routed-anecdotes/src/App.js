...
const Menu = ({anecdotes, addNew, anecdoteById, setNotification}) => {
...
const AnecdoteList = ({ anecdotes }) => {
  console.log('AnecdoteList runs with anecdotes:', anecdotes);
  return (
    <div>
      <h2>Anecdotes</h2>
      <ul>
...
const App = () => {
  ...
  console.log('anecdotes in App', anecdotes)
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdoteById={anecdoteById} setNotification={setNotification} />
      <Footer />
    </div>
  )
}
